		...
		if(isset($_GET['seite'])){
			...
			switch ($seite) {
				case 0:
					...
					break;
				case 1000:
					print ("Aufgabe 1: Hier Angebote anzeigen!");
				...
				case 1100:
					...
					break;
				case 1200:
					print ("Aufgabe 3: Hier ausgewählte Produkte in den warenkorb legen");
					//include("in_den_warenkorb.php");
				
					break;
				case 10:
					print ("Aufgabe 4: Hier die Warenkorb-Übersicht anzeigen!");
